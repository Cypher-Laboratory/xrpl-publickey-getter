...
(async () => {
    ...
    console.log(await (0, addressGetter_1.getAddresses)(10n, 3, curves_1.Curve.SECP256k1));
    // combined calls to getAddresses and getPubKeysFromAddresses
    const retrievedAddresses = await (0, addressGetter_1.getAddresses)(10n, 2, curves_1.Curve.ALL);
    // console.log("addresses: ", retrievedAddresses);
    console.log(await (0, pubKeyGetter_1.getPubKeysFromAddresses)(retrievedAddresses));
})();
