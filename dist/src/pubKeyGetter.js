...
exports.getAddressFromXPubkey = exports.getXPubkeyFromLatestTx = exports.getLatestTx = exports.getPubKeysFromAddresses = void 0;
...
async function getPubKeysFromAddresses(addresses) {
    ...
    const xPubKeys = await Promise.all(addresses.map(async (address) => {
