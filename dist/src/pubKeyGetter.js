...
exports.getPubKeysPoints = exports.getAddressFromSigningPubkey = exports.getSigningPubkeyFromLatestTx = exports.getLatestTx = exports.getPubKeysFromAddresses = void 0;
...
function getAddressFromSigningPubkey(pubkeyHex) {
    ...
    const chksum_hash1 = (0, crypto_1.createHash)("sha256").update(payload).digest();
    const chksum_hash2 = (0, crypto_1.createHash)("sha256").update(chksum_hash1).digest();
...
exports.getPubKeysPoints = getPubKeysPoints;
